...
export type SelectColorWithBG = SelectColor | 'gray_background' | 'brown_background' | 'orange_background' | 'yellow_background' | 'green_background' | 'blue_background' | 'purple_background' | 'pink_background' | 'red_background';
...
export type MentionEmoji = {
    type: 'emoji';
    emoji: string;
};
export type MentionExternalOrFile = {
    type: 'external' | 'file';
    src: string;
    url: string;
};
export type MentionIcon = MentionEmoji | MentionExternalOrFile;
export type PageOrDatabaseMention = {
    id: IdRequest;
    name: string;
    icon: MentionIcon;
};
...
export type DBProperties = Record<string, {
    type: 'title';
...
export type DatabasePropertyRelationConfigResponse = SinglePropertyDatabasePropertyRelationConfigResponse | DualPropertyDatabasePropertyRelationConfigResponse;
